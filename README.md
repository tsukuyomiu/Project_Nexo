# 🛡️ Projeto Nexo - Sistema de Perícia Computacional
...
## 🖥️ Telas do Sistema (Escopo Principal)

Para manter o projeto factível e focado, mapeamos as seguintes telas indispensáveis:

1.  **Autenticação (Login, Cadastro e Recuperação de Senha):** Controle de acesso seguro aos recursos da plataforma.
...
## 🗄️ Arquitetura de Dados (Mapeamento Inicial)
